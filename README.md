...
#Résumé pour la Présentation : Pipeline d'Analyse de Sentiment avec BERT
Introduction
...
Messages de Commit : Descriptifs et clairs, faisant référence aux tâches spécifiques.
